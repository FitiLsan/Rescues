...
namespace Rescues
{
    public sealed class HidingPlaceController : IInitializeController, ITearDownController
    {
        ...
        public void Initialize()
        {
            ...
            {
                var hidingPlaceBehaviour = trigger as HidingPlaceBehaviour;
                hidingPlaceBehaviour.OnFilterHandler += OnFilterHandler;
                hidingPlaceBehaviour.OnTriggerEnterHandler += OnTriggerEnterHandler;
                hidingPlaceBehaviour.OnTriggerExitHandler += OnTriggerExitHandler;
            }
        }
